...
日期： [2015年5月 1日](http://www.ruanyifeng.com/blog/2015/05/)
...
![img](http://www.ruanyifeng.com/blogimg/asset/2015/bg2015043001.jpg)

## 一、参数的求值策略

Thunk函数早在上个世纪60年代就诞生了。

那时，编程语言刚刚起步，计算机学家还在研究，编译器怎么写比较好。**一个争论的焦点是["求值策略"](https://zh.wikipedia.org/wiki/求值策略)，即函数的参数到底应该何时求值。**
...
另一种意见是["传名调用"](https://zh.wikipedia.org/wiki/求值策略#.E4.BC.A0.E5.90.8D.E8.B0.83.E7.94.A8_.28Call_by_name.29)（call by name），即直接将表达式 x + 5 传入函数体，只在用到它的时候求值。Hskell语言采用这种策略。
...
> 本文转自：http://www.ruanyifeng.com/blog/2015/05/thunk.html